...
const writeBulkDataToJSON = async () => {
  try {
    const { data } = await axios.get(
      "https://eodhistoricaldata.com/api/exchanges-list?api_token=5fc7c5353b3562.56305270&fmt=json"
    );
    ...
    exchanges.forEach(async (exchange) => {
      const { data } = await axios.get(
        `https://eodhistoricaldata.com/api/eod-bulk-last-day/${exchange}?api_token=5fc7c5353b3562.56305270&fmt=json`
      );
